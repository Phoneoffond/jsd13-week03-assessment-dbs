...
//
// Your thinking:
// ตอนแรกให้ดึงข้อมูลมาจากฐานข้อมูลที่มีชื่อว่า chrome-burger-db จากนั้นให้เข้าไปหาราคาในคอลแลคชั่น menu_items 
// โดยใช้ find() แล้วใช้เงื่อนไข คือ ราคา หรือ price ต้องน้อยกว่า 10.00 หรือ $lt ใน {}
