...
//
// Your thinking: ดึง side หรือเครื่องเคียงมาจากฐานข่้อมูล menu_items ภายใต้หมวดหมู้ category ที่ตรงกัน
// จากนั้นไม่ให้แสดงผล _id แต่ให้แสดงผลชื่อ name และราคา price
