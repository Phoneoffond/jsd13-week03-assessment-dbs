...
-- ต้องไปกรองชื่อกับนามกุลและรหัสของคนที่เป็น Cashier มาจากฐานข้อมูล Staff ก่อน แล้วค่อยรหัสมานับออเดอร์ ใครมากสุดอยู่ข้างบน แต่พอเขียนโค้ดจริงใช้ WHERE Role = 'cashier' แล้ว bug ตลอดเลยลบออก
